...
import { Dialog, Transition, Listbox, DialogPanel, DialogBackdrop, ListboxButton, ListboxOption, ListboxOptions, TransitionChild } from "@headlessui/react";
...
export default function Settings(): ReactElement<any> {
  ...
  return (
    <>
      <Transition show={settings} as={Fragment}>
        <Dialog
          open={settings}
          onClose={() => {
            setSettings(false);
                            ...
                            <>
                              <div className="mt-1 relative">
                                ...
                                <Transition
                                  ...
                                  leaveTo="opacity-0"
                                >
                                  <ListboxOptions className="bg-white dark:bg-gray-800 absolute mt-1 max-h-60 w-full overflow-auto rounded-md py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm ">
