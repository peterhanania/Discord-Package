	...
	const countries = [
		{
			id: 1,
			name: "English",
			avatar: "https://upload.wikimedia.org/wikipedia/en/thumb/6/6c/Us_flag_large_38_stars.png/1200px-Us_flag_large_38_stars.png",
		},
	];
							...
							<div className="relative shadow-lg bg-[#36393f] ">
								...
								<div className="overflow-y-auto h-[560px] ">
									<div className="py-6 px-8">
										...
										/>{" "}
										<h3 className="text-xl font-medium text-white mb-2 mt-4">
											3- Scroll down to the end then click
											on &quot;Request Data &quot; to
											request your data.
										</h3>
										<Image
										...
										/>
										<h3 className="text-xl font-medium text-white mb-2 mt-4">
											4- Keep checking your email and
											download your data once reached. The
											data will be sent to the email
											associated with your Discord account
											and usually takes up to 24 hours to
											reach.
										</h3>
										<Image
											src="/help/4.png"
										...
										/>
										<h3 className="text-xl font-medium text-white mb-2 mt-4">
											5- Upload the downloaded package by
											dragging or clicking on the box.
										</h3>
										<video controls>
											<source
												src="/help/1.mp4"
										...
										<h3 className="text-xl font-medium text-white mb-2 mt-4">
											You could cancel by pressing on the
											box while its uploading.
										</h3>
										<video controls>
											<source
												src="/help/2.mp4"
										...
										<h3 className="text-xl font-medium text-white mb-2 mt-4">
											...
											Options&quot; to customize what data
											you want to display
										</h3>
										<video controls>
											<source
							...
							<div className="relative shadow-lg bg-[#36393f] ">
								...
								<div className="overflow-y-auto h-[340px]">
									<div className="py-6 px-8 text-white font-bold text-lg">
										Discord Package Explorer is a new tool
										made by{" "}
										<a
										...
										. I got inspired by the idea and decided
										to work on a more customizable one as a
										side project. This project is 100% free
										and will always remain free. My main
										goal is to visualize the data used by
										Discord in a more user friendly way.
										<br />
										<br />
										This project does not store any
										information, and does not have any third
										party services.
										<br />
										<br />
