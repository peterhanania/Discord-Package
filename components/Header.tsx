							...
							<div className="relative shadow-lg bg-[#36393f] ">
								<div className="flex justify-between items-center p-5 rounded-t bg-[#2b2d31]">
									<h3
										...
										style={{
											fontFamily: 'Ginto,system-ui,-apple-system,BlinkMacSystemFont,Helvetica Neue,Helvetica,Arial,sans-serif',
										}}>
										tutorials
									</h3>
									<button
								...
								<div className="overflow-y-auto h-[560px] px-5 py-2">
									<code className="dark:text-white text-black font-bold">
										🎇 If you made a video about DP, make sure to join the discord and let us know! 🎊
									</code>
									<div className="mt-2">
							...
							<div className="relative shadow-lg bg-[#36393f] ">
								...
								<div className="overflow-y-auto h-[560px] ">
									<div className="py-6 px-8">
										<h3 className="text-xl font-medium text-white mb-2">1- Click on the &quot;User Settings&quot; icon.</h3>
										<Image unoptimized={true} src="/help/1.png" alt="1" width={500} height={300} />{' '}
										<h3 className="text-xl font-medium text-white mb-2 mt-4">2- Click on &quot;Privacy & Safety&quot;.</h3>
										<Image unoptimized={true} src="/help/2.png" alt="2" width={500} height={300} />{' '}
										...
										<Image unoptimized={true} src="/help/3.png" alt="3" width={500} height={300} />
										<h3 className="text-xl font-medium text-white mb-2 mt-4">
											4- Keep checking your email and download your data once reached. The data will be sent to the email associated with your Discord
											account and usually takes up to 24 hours to reach.
										</h3>
										<Image unoptimized={true} src="/help/4.png" alt="4" width={500} height={30} />{' '}
										<Image unoptimized={true} src="/help/5.png" alt="5" width={500} height={300} />
										<h3 className="text-xl font-medium text-white mb-2 mt-4">5- Upload the downloaded package by dragging or clicking on the box.</h3>
										<video controls>
											<source src="/help/1.mp4" type="video/webm" />
											Your browser does not support embedded videos
										</video>{' '}
										<h3 className="text-xl font-medium text-white mb-2 mt-4">You could cancel by pressing on the box while its uploading.</h3>
										<video controls>
											<source src="/help/2.mp4" type="video/webm" />
											Your browser does not support embedded videos.
										</video>
										<h3 className="text-xl font-medium text-white mb-2 mt-4">
											You could press &quot;More Options&quot; to customize what data you want to display
										</h3>
										<video controls>
							...
							<div className="relative shadow-lg bg-[#36393f] ">
								...
								<div className="overflow-y-auto h-[340px]">
									<div className="py-4 px-2 lg:py-6 lg:px-8 md:py-6 md:px-8 sm:py-6 sm:px-8 text-white font-bold text-lg">
										...
										. I got inspired by the idea and decided to work on a more customizable one as a side project. This project is 100% free and will
										always remain free. My main goal is to visualize the data used by Discord in a more user friendly way.
										<br />
										<br />
										This project does not store any information, and does not have any third party services other than Google Analytics.
										<br />
										<br />
										...
										<a href="https://github.com/peterhanania/discord-package/graphs/contributors">
											...
											<img src="https://contrib.rocks/image?repo=peterhanania/discord-package" alt="Contributors" />
										</a>
									</div>
								</div>
								...
								<div className="overflow-y-auto h-[280px]">
									<div className="py-4 px-2 lg:py-6 lg:px-8 md:py-6 md:px-8 sm:py-6 sm:px-8 text-white font-bold text-lg">
										...
										<div
											...
											<input type="radio" name="theme" id="dark" value="dark" onChange={() => {}} checked={theme === 'dark'} />
										...
										<div
											...
											<input type="radio" name="theme" id="light" value="light" onChange={() => {}} checked={theme === 'light'} />
															...
															<div className="mt-1 relative">
																<Listbox.Button className="relative w-full cursor-pointer bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm pl-3 pr-10 py-2 text-left sm:text-sm">
																	<span className="flex items-center">
																		...
																		/>
																		<span className="ml-3 block truncate text-slate-900 dark:text-white">{selected.name}</span>
																	</span>
																	...
																	<Listbox.Options className="bg-white dark:bg-gray-800 z-10 absolute mt-1 max-h-60 w-full overflow-auto rounded-md py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm ">
																		{countries.map((country) => (
																			<Listbox.Option
																				...
																				className={({ active }) =>
																					classNames(
																						active ? 'text-gray-900 bg-indigo-600' : 'text-gray-900',
			...
			<header className="flex flex-col items-center lg:pt-20 md:pt-16 pt-4">
				...
				<div className="portrait:hidden lg:hidden landscape:flex md:landscape:hidden lg:text-xl md:text-xl text-sm mt-1 animate__delay-1s animate__animated animate__fadeIn flex justify-center items-center text-slate-900 dark:text-gray-200 font-bold">
					<Link href="/demo" target="_blank" rel="noreferrer" type="button">
						<a className="button-green text-gray-200  my-2 flex items-center">Click to View Demo</a>
					</Link>
				</div>
				<div className="flex justify-center items-center mt-2">
					<Tippy zIndex={999999999999999} content={'Help'} animation="scale" className="shadow-xl ">
						<svg
					...
					<Tippy zIndex={999999999999999} content={'Settings'} animation="scale" className="shadow-xl">
						<svg
					...
					<Tippy zIndex={999999999999999} content={'About'} animation="scale" className="shadow-xl">
						<svg
					...
					<Tippy zIndex={999999999999999} content={'Tutorials'} animation="scale" className="shadow-xl">
						<svg
