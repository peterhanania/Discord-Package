 ...
 * 
 * @deprecated Use the `copyToClipboard` helper from `utils/copyToClipboard.ts` instead.
 */
              ...
              <div className="lg:flex md:flex items-center text-gray-900 dark:text-white space-y-1">
                ...
                <div className="flex items-center">
                  ...
                  {data?.messages?.favoriteWords &&
                    ...
                    <Tippy
                      zIndex={99999999999999}
                      content={`${data.messages.favoriteWords.length
                        } Favorite Word${data.messages.favoriteWords.length > 1 ? "s" : ""
                        }`}
                      animation="scale"
                      className="shadow-xl"
                    >
                ...
                if (m.type && (obj as any)[m.type]) {
                  return (
                    <div className="cursor-pointer" key={i}>
                      <Tippy
                        zIndex={99999999999999}
                        content={`${(Connections as any)[m.type].name}: ${m?.name
                          } ${m.visible ? "[VISIBLE]" : ""}`}
                        animation="scale"
                        className="shadow-xl"
                      >
                      ...
                      tooltip: {
                        ...
                        formatter: function (this: any): string {
                          if (graphOption === "hourly") {
                            return `<p style="font-weight: 200; font-family: Inter; color: white"></span><b style="font-weight: 600; font-family: Inter; color: white" ><span>${this.y
                              }</b> messages ${this.x && days_[this.x]
                                ? `at ${days_[this.x]}`
                                : `at ${days_[0]}`
                              }</p>`;
                          } else if (graphOption === "daily") {
                            return `<p style="font-weight: 200; font-family: Inter; color: white"></span><b style="font-weight: 600; font-family: Inter; color: white" ><span>${this.y
                              }</b> messages ${this.x && days_daily[this.x]
                                ? `at a ${days_daily[this.x]}`
                                : `at a ${days_daily[0]}`
                              }</p>`;
                          } else if (graphOption === "monthly") {
                            return `<p style="font-weight: 200; font-family: Inter; color: white"></span><b style="font-weight: 600; font-family: Inter; color: white" ><span>${this.y
                              }</b> messages ${this.x && days_monthly[this.x]
                            ...
                            if (years) {
                              ...
                              return `<p style="font-weight: 200; font-family: Inter; color: white"></span><b style="font-weight: 600; font-family: Inter; color: white" ><span>${this.y
                                }</b> messages ${this.x && years_[this.x]
                                  ? `in ${years_[this.x]} `
                                  : `in ${years_[0]} `
                                }</p>`;
                          ...
                          <div className="lg:flex md:flex sm:flex items-center lg:py-10 md:py-10 sm:py-10 py-2 sm:flex-row lg:h-1 md:h-1 sm:h-1 hover:bg-gray-400 dark:hover:bg-[#23272A] px-2 rounded-lg">
                            ...
                            <div className="flex items-center self-center ml-auto lg:grid my-4 grid-rows-2 grid-flow-col gap-1">
                              ...
                              {m?.favoriteWords &&
                                ...
                                <Tippy
                                  zIndex={99999999999999}
                                  content={`${m.favoriteWords.length
                                    } Favorite Word${m.favoriteWords.length > 1 ? "s" : ""
                                    }`}
                                  animation="scale"
                                  className="shadow-xl"
                                >
                              ...
                              {m?.oldestMessages &&
                                ...
                                <Tippy
                                  zIndex={99999999999999}
                                  content={`${m.oldestMessages.length
                                    } Oldest Message${m.oldestMessages.length > 1 ? "s" : ""
                                    }`}
                                  animation="scale"
                                  className="shadow-xl"
                                >
                              ...
                              {m?.topEmojis && m?.topEmojis?.length > 0 ? (
                                <Tippy
                                  zIndex={99999999999999}
                                  content={`${m.topEmojis.length} Top Emoji${m.topEmojis.length > 1 ? "s" : ""
                                    }`}
                                  animation="scale"
                                  className="shadow-xl"
                                >
                              ...
                              {m?.topCustomEmojis &&
                                ...
                                <Tippy
                                  zIndex={99999999999999}
                                  content={`${m.topCustomEmojis.length
                                    } Top Custom Emoji${m.topCustomEmojis.length > 1 ? "s" : ""
                                    }`}
                                  animation="scale"
                                  className="shadow-xl"
                                >
                            ...
                            <div className="lg:flex md:flex sm:flex items-center lg:py-10 md:py-10 sm:py-10 py-2 sm:flex-row lg:h-1 md:h-1 sm:h-1 hover:bg-gray-400 dark:hover:bg-[#23272A] px-2 rounded-lg ">
                              ...
                              <div className="flex items-center self-center ml-auto lg:grid my-4 grid-rows-2 grid-flow-col gap-1">
                                ...
                                {m?.topEmojis &&
                                  ...
                                  <Tippy
                                    zIndex={99999999999999}
                                    content={`${m.topEmojis.length
                                      } Top Emoji${m.topEmojis.length > 1 ? "s" : ""
                                      }`}
                                    animation="scale"
                                    className="shadow-xl"
                                  >
                                ...
                                {m?.topCustomEmojis &&
                                  ...
                                  <Tippy
                                    zIndex={99999999999999}
                                    content={`${m.topCustomEmojis.length
                                      } Top Custom Emoji${m.topCustomEmojis.length > 1
                                        ? "s"
                                        : ""
                                      }`}
                                    animation="scale"
                                    ...
                                    <div className="flex items-center self-center ml-auto lg:grid my-4 grid-rows-2 grid-flow-col gap-1">
                                      ...
                                      {m?.favoriteWords &&
                                        ...
                                        <Tippy
                                          zIndex={99999999999999}
                                          content={`${m.favoriteWords.length
                                            } Favorite Word${m.favoriteWords.length > 1
                                              ? "s"
                                              : ""
                                            }`}
                                          animation="scale"
                                      ...
                                      {m?.oldestMessages &&
                                        ...
                                        <Tippy
                                          zIndex={99999999999999}
                                          content={`${m.oldestMessages.length
                                            } Oldest Message${m.oldestMessages.length > 1
                                              ? "s"
                                              : ""
                                            }`}
                                          animation="scale"
                                      ...
                                      {m?.topEmojis &&
                                        ...
                                        <Tippy
                                          zIndex={99999999999999}
                                          content={`${m.topEmojis.length
                                            } Top Emoji${m.topEmojis.length > 1
                                              ? "s"
                                              : ""
                                            }`}
                                          animation="scale"
                  ...
                  .map((b: any, i: number) => {
                    return (
                      ...
                      >
                        <Tippy
                          zIndex={99999999999999}
                          content={`${b?.verified ? "[🗸 VERIFIED]" : ""} ${b.name
                            }`}
                          animation="scale"
                          className="shadow-xl"
                        >
          ...
          <div id="blur_10_div">
            ...
            <div className="text-gray-900 dark:text-white md:text-xl lg:text-xl font-bold text-[16px] mt-2">
              {data?.statistics
                ...
                : `This option was disabled by ${data?.dataFile ? "them" : "you"
                }.`}
            </div>
          </div>{" "}
        </div>
